        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt('return', this.getUserFunc(id));
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt('return', this.getUserScopes(user));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                scope = void 0;
                _context3.next = 5;
                return this.redis.hgetall('tokens:' + bearer);
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 6;
                return this.redis.hmset('tokens:' + accessToken, 'user', userKey);

              case 6:
                _context4.next = 8;
                return this.redis.expire('tokens:' + accessToken, this.config.accessTokenLife);
              ...
              case 11:
                _context4.next = 13;
                return this.redis.hmset('tokens:' + accessToken, 'user', userKey, 'refresh', refreshToken, 'expires', expires);

              case 13:
                _context4.next = 15;
                return this.redis.expire('tokens:' + accessToken, this.config.refreshTokenLife);
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return this.redis.ttl('tokens:' + access);
              ...
              case 2:
                ...
                return _context5.abrupt('return', this.redis.expire('tokens:' + access, 10));
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return this.redis.hgetall('tokens:' + access);
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _context7.next = 3;
                return this.redis.set('reset:' + resetToken, userKey, 'EX', this.config.resetTokenLife);
        ...
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _context8.next = 2;
                return this.redis.get('reset:' + token);
        ...
        return regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                return _context9.abrupt('return', this.redis.del('reset:' + token));
